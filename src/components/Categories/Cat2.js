...
const Categories = ({ devicePhone }) => {
    ...
    const currentCityCat = useContext(CityContext)
    const currentCity = currentCityCat[0].citiesList[0].slug

    console.log(currentCityCat[1]);
                            ...
                            {catShow.sub.map((cat) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* <a href={navigate.pathname + "/"+cat.slug}>{cat.title}</a> */}
                                        <Link to={"/s/" + currentCity + "/" + cat.slug}>{cat.title}</Link>
                                        {/* {cat.title} */}
